...
public partial class HighSchoolDatabaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Student>(entity =>
        {
            ...
            entity.Property(e => e.LastEdit).HasColumnType("datetime");
            entity.Property(e => e.Name).HasMaxLength(25);
            entity.Property(e => e.RegistryYear).HasColumnType("int");
        ...
        modelBuilder.Entity<Studentsdayoff>(entity =>
        {
            modelBuilder.Entity<Studentsdayoff>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdStudentsDayoff).IsUnique();

                entity.Property(e => e.IdstudentNumber).HasColumnType("integer");
                entity.Property(e => e.IdStudentsDayoff).HasColumnName("idStudentsDayoff");
                entity.Property(e => e.Date).HasColumnType("date");
                entity.Property(e => e.Reason).HasMaxLength(45);

                entity.HasOne(e => e.IdstudentNumberNavigation) // Student sınıfını referans alıyoruz
                      .WithMany(s => s.StudentsDayoffHasStudents) // İlişkili nesne koleksiyonu
                      .HasForeignKey(e => e.IdstudentNumber) // İlişki anahtarı
                      .OnDelete(DeleteBehavior.Restrict); // Silindiğinde ne olacağını belirliyoruz
            ...
            modelBuilder.Entity<Teacher>(entity =>
        {
            ...
            entity.HasOne(d => d.IdTeachersNavigation).WithOne(p => p.Teacher)
                .HasPrincipalKey<Schoolmanagementattendant>(p => p.IdTeacher)
                .HasForeignKey<Teacher>(d => d.IdTeachers)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_Teachers_SchoolManagementAttendants1");

            entity.HasMany(d => d.IdCourses).WithMany(p => p.IdTeachers)
                .UsingEntity<Dictionary<string, object>>(
                    "TeachersHasCourse",
                    ...
                    j =>
                    {
                        j.HasKey("IdTeachers", "IdCourse").HasName("PRIMARY");
                        j.ToTable("teachers_has_courses");
                        j.HasIndex(new[] { "IdCourse" }, "fk_Teachers_has_Courses_Courses1_idx");
                        j.HasIndex(new[] { "IdTeachers" }, "fk_Teachers_has_Courses_Teachers1_idx");
                        j.IndexerProperty<int>("IdTeachers").HasColumnName("idTeachers");
